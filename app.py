...
# Muat contoh gambar dan train cara mengenalinya
...
def gen_frames():
    while True:
        success, frame = camera.read()  # buka kamera
        if not success:
            break
        else:
